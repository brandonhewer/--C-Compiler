...
CREATE_DEFAULT_ANNOTATOR(primary_expression)
CREATE_DEFAULT_ANNOTATOR(function_application)
CREATE_DEFAULT_ANNOTATOR(postfix_expression)
CREATE_DEFAULT_ANNOTATOR(argument_list)
CREATE_DEFAULT_ANNOTATOR(argument_expression_lists)
CREATE_DEFAULT_ANNOTATOR(unary_expression)
CREATE_DEFAULT_ANNOTATOR(multiplicative_expression)
CREATE_DEFAULT_ANNOTATOR(additive_expression)
CREATE_DEFAULT_ANNOTATOR(relational_expression)
CREATE_DEFAULT_ANNOTATOR(equality_expression)
CREATE_DEFAULT_ANNOTATOR(assignment)
CREATE_DEFAULT_ANNOTATOR(assignment_expression)
CREATE_DEFAULT_ANNOTATOR(expression)
